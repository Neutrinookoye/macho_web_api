...
@section("page_title", "Newsletter Emails")
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="#" class="btn btn-warning font-weight-bolder font-size-sm mr-3" data-toggle="modal" data-target="#export-lead">
                <i class="flaticon2-pen"></i> Export Emails
            </a>
        </div>
    </div>
    <!--end::Subheader-->
                                            ...
                                            <div>
                                                <span class="text-dark-75 font-weight-bolder d-block font-size-lg">
                                                    @php
                                                        ...
                                                        $emailDate = $carbonDate->format('d/m/Y');
                                                    @endphp
                                                    {{ $emailDate }}
                                                </span>
                                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel"><b>Export Newsletter Emails</b></h6>
            ...
            <div class="modal-body">
                <div class="card card-custom">
                    ...
                    <!--begin::Form-->
                    <form class="form" action="{{ route('admin.newsletter.export') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- <div class="card-body">
