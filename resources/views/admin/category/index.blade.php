    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="#" class="btn btn-warning font-weight-bolder font-size-sm mr-3" data-toggle="modal" data-target="#create-category">
                <i class="flaticon2-pen"></i> Create Category
            </a>
        </div>
    </div>
    <!--end::Subheader-->
                                ...
                                <tbody>
                                    ...
                                    @foreach($categories as $category)
                                        <tr>
                                            ...
                                            <td>
                                                <button href="#" class="btn btn-icon btn-warning" data-toggle="modal" data-target="#edit-category{{ $category->id }}">
...
<!--begin::Footer-->
@foreach($categories as $category)
    <div class="modal fade" id="edit-category{{ $category->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="card card-custom">
                        ...
                        <form action="{{ route('admin.category.edit', $category->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            @method('PUT')
                            <div class="card-body">
                                <input name="type" type="hidden" value="{{ $type ?? 'general' }}" readonly>
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" name="description" class="form-control" required="required">{{ $category->description }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <hr>
