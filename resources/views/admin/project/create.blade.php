            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-md-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.project.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea rows="3" type="text" minlength="200" maxlength="300" class="form-control" name="short_description" placeholder="">{{ old('short_description') }}</textarea>
                                    </div>
                                </div>
