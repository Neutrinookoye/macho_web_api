            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-md-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.case.studies.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" maxlength="40" name="caption" placeholder="Case Study Caption" value="{{ old('caption') }}" />
                                    </div>
                                    <div class="col-lg-2">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <select id="category" name="project" class="form-control">
                                            ...
                                            @foreach($projects as $project)
                                                <option value="{{ $project->id }}" @if($project->id == old('project')) selected @endif>{{ $project->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <textarea type="text" id="outcome" class="form-control" name="outcome" placeholder="">{{ old('outcome') }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row pt-3">
                                    <div class="col-lg-6">
                                        <label>Video URL <span class="text-danger"><b>*</b></span> <span class="font-weight-bolder"></span></label>
                                        <div class="input-group">
