...
@section("page_title", "Create Award")
            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-md-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.award.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="text" class="form-control" name="issuer" placeholder="" value="{{ old('issuer') }}" />
                                        </div>
                                        <div class="col-lg-6">
                                            <label>Award Image <span class="text-danger"><b>*</b></span> <small>(222px x 220px)</small></label>
