...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="{{ route('admin.blog.index') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-md-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.blog.edit', $blog->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <textarea rows="3" type="text" class="form-control" name="short_description" placeholder="">{{ $blog->short_description }}</textarea>
                                        </div>
                                    </div>
