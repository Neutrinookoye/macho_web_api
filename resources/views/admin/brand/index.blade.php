...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="#" class="btn btn-warning font-weight-bolder font-size-sm mr-3" data-toggle="modal" data-target="#create-brand">
                            ...
                            <table id="example" class="table table-separate table-head-custom table-checkable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-icon btn-warning" data-toggle="modal" data-target="#edit-brand{{ $brand->id }}">
...
@foreach($brands as $brand)
    <div class="modal fade" id="edit-brand{{ $brand->id }}" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                        ...
                        <form action="{{ route('admin.brand.edit', $brand->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <label>Brand Image <span class="text-danger"><b>*</b></span></span> <span class="font-weight-bolder"></span></label>
...
<div class="modal fade" id="create-brand" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="exampleModalLabel"><b>Create New Brand</b></h6>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
