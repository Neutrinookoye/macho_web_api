...
@section("page_title", "Create Job Application")
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="{{ route('admin.career.index') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
                <i class="ki-duotone ki-add-folder"></i> View all Applications
            </a>
        </div>
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.career.create') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                {{-- <div class="form-group row"> --}}
                                    {{-- <div class="col-lg-4">
                                        <label>CV <span class="text-danger"><b>*</b></span></label>
                                        <input type="file" class="form-control" name="cv" placeholder="" accept=".pdf, .doc, .docx" value="{{ old('cv_file_name') }}" />                                        
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Cover Letter <span class="text-danger"><b>*</b></span></label>
                                        <input type="file" class="form-control" name="cover_letter" placeholder="" accept=".pdf, .doc, .docx" value="{{ old('cover_letter_file_name') }}" />                                        
                                    </div> --}}
                                {{-- </div> --}}
