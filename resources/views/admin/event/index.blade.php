...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="{{ route('admin.event.create') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
                                        ...
                                        <div class="card-xl-stretch me-md-6">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <div class="fs-6 mt-1 d-flex flex-stack">
                                                    <p>
                                                        Created on {{ date('d M, Y', strtotime($event->created_at)) }} by {{ $event->created_by_name }}
                                                    </p>
                                                </div>

                                                <div class="fs-6 fw-bold mt-2 d-flex flex-stack">
                                                    
                                                        <a href="{{ route('admin.event.edit', $event->id) }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
