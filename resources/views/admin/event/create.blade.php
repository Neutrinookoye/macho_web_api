            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-md-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.event.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="datetime-local" class="form-control" name="start_time" placeholder="" value="{{ old('start-time') }}" />
                                    </div>

                                    <div class="col-lg-6">
                                        <label>End time <span class="text-danger"><b>*</b></span></label>
                                        <input type="datetime-local" class="form-control" name="end_time" placeholder="" value="{{ old('end-time') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group row pt-3">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <select name="status" class="form-control">
                                            <option class="form-control" value="Select an Option">Select an Option</option>
                                            <option class="form-control" value="upcoming">Upcoming</option>
