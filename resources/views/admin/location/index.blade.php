...
@section("page_title", "View Locations")
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="{{ route('admin.location.create') }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
                <i class="flaticon2-pen"></i> Create Location
            </a>
        </div>
    </div>
    <!--end::Subheader-->
                            ...
                            <table id="example" class="table table-separate table-head-custom table-checkable" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.location.edit', $location->id) }}" class="btn btn-warning font-weight-bolder font-size-sm mr-3">
