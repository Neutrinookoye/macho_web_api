...
@section("page_title", "Create Publication")
            ...
            <div class="row">
                ...
                <div class="col-xxl-12 col-md-12 order-2 order-xxl-1">
                    ...
                    <div class="card card-custom card-stretch gutter-b">
                        ...
                        <form class="form" action="{{ route('admin.publication.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <textarea rows="3" type="text" class="form-control" name="description" placeholder="">{{ old('description') }}</textarea>
                                    </div>
                                </div>
